...
!function (a, b) {
    ...
    var n = {
        ...
        closeButton: "<button type='button' class='bootbox-close-button close hide' data-dismiss='modal' aria-hidden='true'><b>&times;</b></button>",
    ...
    p.alert = function () {
        ...
        if (g(j, function (a, b) {
            ...
            d.find(".modal-header").addClass(hc);
        }
